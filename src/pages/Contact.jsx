...
const Contact = () => {
    return (
        <div>
            ...
            {/* <img className='class="bg-img1 txt-center p-lr-15 p-tb-92"' src={img} alt="" /> */}
            ...
            {/* <!-- Content page --> */}
            <section class="bg0 p-t-0 p-b-16">
                <div class="container">
                            ...
                            <div class="flex-w w-full p-b-42">
                                ...
                                <div class="size-212 p-t-2">
                                    ...
                                    <p class="stext-115 cl6 size-213 p-t-18">
                                        Av. siempre viva y America, edificio blanco, puerta naranja
                                    </p>
                                </div>
                            </div>
